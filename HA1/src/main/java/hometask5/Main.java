...
//        card3.cardInformation();
        ...
        ATMBuilder atm = new ATMBuilder(10,0,0);
//        atm.addBanknotes(Integer.parseInt(BanknotesNominal.TWENTY.getTitle()), 30);
//        atm.addBanknotes(Integer.parseInt(BanknotesNominal.FIFTY.getTitle()), 10);
//        atm.addBanknotes(Integer.parseInt(BanknotesNominal.HUNDRED.getTitle()), 10);

        System.out.println(atm.getNumberOfBanknotes20());
        System.out.println(atm.getNumberOfBanknotes50());
        System.out.println(atm.getNumberOfBanknotes100());
        atm.isSuccessfulOperation(150);
        System.out.println(atm.getNumberOfBanknotes20());
        System.out.println(atm.getNumberOfBanknotes50());
        System.out.println(atm.getNumberOfBanknotes100());
